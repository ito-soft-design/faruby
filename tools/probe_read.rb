...
7 => [
  # 4 ワード刻みなら 0 番は D1100-D1103、1 番は D1104-。
  # 6 ワード刻み (詰め物あり) なら 1 番は D1106 から始まる
  ["37 0 番のタグ",              "D1100", :s16, 4],
  ["37 0 番の値",                "D1101", :s32, 123_456],
  ["37 1 番のタグ (4 ワード刻み)", "D1104", :s16, 4],
  ["38 添字を変数で (2 番)",      "D1108", :s16, 9],
  ["38 2 番の値",                "D1109", :s32, 555],
  ["39 実数で書いて整数で読む",    "D1113", :s32, 1_075_838_976],
  ["40 構造体どうしの写し",       "D1105", :s32, 123_456],
],
  4 => [
